...
% Lena (Lena S?derberg), Swedish model, originally cropped from the centerfold of 
...
rect = getrect;                     % select rectangle using the mouse. See also: impoint, imline, impoly
